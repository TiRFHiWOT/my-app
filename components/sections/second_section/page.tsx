...
import CommentSwiper from "@/components/CommentSwiper/page";
...
export default function Second_section() {
  ...
  return (
    <>
      <div
        className={"w-full h-auto flex flex-col items-center max-[1400px]:px-4"}
      >
        <motion.div
            ...
            {BENEFITS.map((value, index) => (
              ...
              >
                ...
                <div
                  className={`${
                    index === 3 ? `opacity-0` : ``
                  } max-[650px]:hidden w-0.5 h-32 bg-[#13519C]`}
                ></div>
              </div>
            ))}
          </div>
        ...
        <div
          className={
            "w-full flex max-[1150px]:flex-col max-[1150px]:items-center items-start mt-16 justify-center"
          }
        >
          <motion.div
          ...
          >
            ...
            >
              <span className="mask_text">WHO WE ARE ?</span>
              <span style={{ letterSpacing: 0 }} className="mask_text2">
            ...
            >
              We are committed to serve our customers during or after the
              purchase of your policy, handover all your insurance related
            ...
            {CARDS.map((value, index) => (
              ...
              >
                ...
                >
                  ...
                  <span
                    className={
                      "text-[22px] max-[1300px]:text-xl font-[400] mt-4"
                    }
                  >
                    {value.title}
                  </span>
        ...
        <div
          className={"w-full h-auto flex flex-col items-center relative mt-20"}
        >
          <Image
          ...
          >
            <span className="mask_text3">WHY RIELVERSE.COM ?</span>
            <span className="mask_text4">
              Insurance Has Never Been So Simple & <br /> We Are Trying To Make
              It Even More!
            </span>
            ...
            <span
              style={{ fontWeight: "400", fontFamily: "Arboria-Book" }}
              className={
                "text-[14px] max-[800px]:text-[16px] max-[800px]:leading-7 leading-10 mt-4"
              }
            >
              Be it the Comparisons, Helping you find the best plan for your
              needs, Making changes to your existing policy or even claims - We
          ...
          <div
            className={
              "w-full min-[1800px]:max-w-[1440px] max-w-[1200px] px-[3px] pt-[3px] rounded-xl h-auto bg-gradient-to-t from-transparent to-[#13519C] mt-12 max-[800px]:mt-6 "
            }
          >
            <div
              className={
            ...
            >
              {OFFERS.map((value, index) => (
                <motion.div
                  ...
                  data-aos="zoom-out"
                  className={
                    "w-1/3 max-[650px]:w-full h-auto flex items-center"
                  }
                >
                  <div
                    key={index}
                    className={
                      "w-full h-auto flex flex-col justify-center items-center px-4"
                    }
                  >
                    <span
                      style={{ fontWeight: "400", fontFamily: "Arboria-Book" }}
                    ...
                    <Image
                      className={
                        "w-24 h-fit max-[800px]:w-16 max-h-[65px] object-contain mt-5"
                      }
                      src={value.image}
                      alt={"Railverse"}
                    />
                    ...
                    <span
                      className={
                        "text-[20px] max-[800px]:text-[18px] text-[#13519C] font-[400] mt-2"
                      }
                    >
                      {value.subtitle}
                    </span>
                    <span
                      style={{ fontWeight: "400", fontFamily: "Arboria-Book" }}
                      className={
                        "text-[14px] max-[800px]:text-[12px] max-[800px]:leading-5 mt-4 text-center tracking-[0.5px] leading-7"
                      }
                    >
                      {value.description}
                    </span>
        ...
        <div
          className={
            "w-full flex max-[1150px]:flex-col max-[1150px]:items-center items-start  mt-24"
          }
        >
          <motion.div
          ...
          >
            ...
            <p
              className={
                "text-[36px] max-[800px]:text-3xl leading-[25px] font-[400] mt-0"
              }
            >
              <span className="mask_text5">What they say</span>
              <br />
              <span className={"relative"}>
                About us
                <Image
                  className={
                    "absolute -bottom-4 w-[175px] h-[17px] object-contain"
                  }
                  src={green_stripe}
                  alt={"stripe"}
                />
            ...
            <p
              style={{ fontWeight: "400", fontFamily: "Arboria-Book" }}
              className={
                "text-[21px] max-[800px]:text-lg max-[800px]:mt-4 tracking-[1px] leading-[40px] mt-12 "
              }
            >
              {`We're honoured to have helped these begin a`}
              <span className={"text-[#13519C]"}> SMILING FACES </span> new life
              abroad
            </p>
