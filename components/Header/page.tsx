...
import download from "@/components/Reilverse_Assets/export-file 3.svg";
...
import closeIcon from "@/components/Reilverse_Assets/closeIcon.svg";
import loginBtnIcon from "@/components/Reilverse_Assets/loginBtnIcon.svg";
import myAccountImg from "@/components/Reilverse_Assets/vectorMyAccount.svg";
import myAccountImg2 from "@/components/Reilverse_Assets/vectorMyAccount2.svg";
import myAccountImg3 from "@/components/Reilverse_Assets/vectorMyAccount3.svg";
import msg from "@/components/Reilverse_Assets/msg.svg";
import userIcon from "@/components/Reilverse_Assets/userIcon.svg";
import arrow from "@/components/Reilverse_Assets/ArrowDown.svg";
import couple from "@/components/Reilverse_Assets/loginCouple.svg";
import helpIcon1 from "@/components/Reilverse_Assets/helpIcon1.svg";
import helpIcon2 from "@/components/Reilverse_Assets/helpIcon2.svg";
import helpIcon3 from "@/components/Reilverse_Assets/helpIcon3.svg";
import helpIcon4 from "@/components/Reilverse_Assets/helpIcon4.svg";
import girl from "@/components/Reilverse_Assets/image 20.svg";
import { IoIosArrowForward } from "react-icons/io";
import Image from "next/image";
import { useRouter } from "next/navigation";
import Link from "next/link";
import GoogleTranslate from "../GoogleTranslate/page";
...
export default function Header() {
  ...
  const personalLinks = [
    ...
    },
    {
      ...
      routeUrl: "/personal_cyber_insurance",
      classList:
        "py-3 px-2 hover:text-[#000] flex font-semibold text-[12px] tracking-[1px]",
      description:
    ...
    },
    {
      ...
      routeUrl: "/luxury_watch_insurance",
      classList:
        "py-3 px-2 hover:text-[#000] flex font-semibold text-[12px] tracking-[1px]",
      description:
    ...
    },
    {
      ...
      routeUrl: "/personal_accident_insurance",
      classList:
        "py-3 px-2 hover:text-[#000] flex font-semibold text-[12px] tracking-[1px]",
  ...
  const businessLinks = [
    {
      ...
      routeUrl: "/architect_and_surveyors_insurance",
      classList:
    ...
    },
    {
      ...
      routeUrl: "/Technology_Services_insurance",
      classList:
        "py-3 px-2 hover:text-[#000] flex font-semibold text-[12px] tracking-[1px] font-medium",
      description:
    ...
    },
    {
      ...
      routeUrl: "/Professional_Services_insurance",
      classList:
        "py-3 px-2 hover:text-[#000] flex font-semibold text-[12px] tracking-[1px] font-medium",
      description:
    ...
    },
    {
      ...
      routeUrl: "/food_And_Beverage_insurance",
      classList:
        "py-3 px-2 hover:text-[#000] flex font-semibold text-[12px] tracking-[1px] font-medium",
      description:
    ...
    },
    {
      ...
      routeUrl: "/Interior_Design_And_Renovation_insurance",
      classList:
        "py-3 px-2 hover:text-[#000] flex font-semibold text-[12px] tracking-[1px] font-medium",
    },
    {
      linkName: "Construction",
      routeUrl: "/Construction_insurance",
      description:
    ...
    },
    {
      ...
      routeUrl: "/Manufacturing_and_Storage_insurance",
      classList:
        "py-3 px-2 hover:text-[#000] flex font-semibold text-[12px] tracking-[1px] font-medium",
      description:
    ...
    },
    {
      ...
      routeUrl: "/Wellness_And_Fitness_insurance",
      classList:
        "py-3 px-2 hover:text-[#000] flex font-semibold text-[12px] tracking-[1px] font-medium",
      description:
    ...
    },
    {
      ...
      routeUrl: "/Health_Care_Services_insurance",
      classList:
        "py-3 px-2 hover:text-[#000] flex font-semibold text-[12px] tracking-[1px] font-medium",
      description:
    ...
    },
    {
      ...
      routeUrl: "/entertainment_insurance",
      classList:
        "py-3 px-2 hover:text-[#000] flex font-semibold text-[12px] tracking-[1px] font-medium",
      description:
  ...
  return (
    <>
      <div className={`containerOne mx-auto`}>
        <div className="wrapper ">
          <div
            className={
              "w-full max-[1150px]:px-5 max-[1440px]:px-[80px] max-w-[1400px] min-[1800px]:max-w-[1600px] flex items-center justify-between relative z-10 mt-6"
            }
          >
            <div className="logo_wrapper">
              <Link href={"/"}>
                <Image
                  className={
                    "w-fit max-w-[300px] h-7 max-[500px]:h-5 max-[1350px]:h-7 object-contain"
                  }
                  src={logo}
                  alt={"Railverse Logo"}
                />
            ...
            <div className="nav_links">
              <div>
                <Link
                  ...
                  href={"/car_brand"}
                  className={
                    "pb-2 text-[14px] tracking-[1px] font-semibold flex items-center gap-2 "
                  }
                >
                  Personal
                ...
                <div className="w-full flex justify-center">
                  ...
                  >
                    <div className="flex justify-center gap-3 shadow-lg px-14 py-5 backdrop-blur-2xl rounded-xl">
                      ...
                      <div>
                        <Image src={girl} alt="" className="w-[285px]" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full flex justify-center">
                  ...
                  >
                    <div className="flex justify-center gap-4 shadow-lg px-14 py-5 backdrop-blur-2xl rounded-2xl">
                      ...
                      <div>
                        <Image src={girl} alt="" className="w-[350px]" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {NAV_LINKS.map((value, index) => (
                <Link
                  ...
                  key={index}
                  href={value.to}
                  className={"font-semibold text-[14px] pb-2 tracking-[1px]"}
                >
                  {value.title}
                </Link>
              ))}
            ...
            <div
              className={"w-auto flex items-center max-[1150px]:hidden gap-5"}
            >
              ...
              <div onMouseLeave={() => setUnHide(false)}>
                ...
                <span className="text-[#13519C] text-center font-medium text-[12px]">
            ...
            <div className={"flex items-center lg:hidden gap-8"}>
              <div
                className={
                  "p-2 rounded-full bg-[#13519C86]/80 max-[500px]:hidden  "
                }
              >
            ...
            <div
              ...
              } min-[1150px]:hidden pt-28 px-10 w-full h-screen bg-white absolute left-0 duration-700 ease-in-out -z-10 flex flex-col items items-start `}
            >
              <div
                className={
                  "p-2 min-[500px]:hidden self-start rounded-full bg-white mb-3  "
                }
              >
                <FiSearch className={"text-3xl"} />
              </div>
              ...
              <div className={`nav_links_mob`}>
                <span
                  className={
                    "cursor-pointer text-[16px] flex items-center gap-2 relative min-[600px]:hidden text-gray-700 font-semibold"
                  }
                >
                ...
                <span
                  className={
                    "text-[16px] flex items-center gap-2 min-[600px]:hidden text-gray-700 font-semibold"
                  }
                >
                ...
                <span
                  className={
                    "text-[16px] min-[600px]:hidden flex items-center gap-2 text-gray-700 font-semibold"
                  }
                >
                ...
                <Link
                  ...
                  href={""}
                  className={
                    "text-[16px] tracking-[1px] flex items-center gap-2 text-gray-700 font-semibold"
                  }
                >
                ...
                {NAV_LINKS.map((value, index) => (
                  <Link
                    ...
                    href={value.to}
                    className={
                      "flex text-[16px] items-center tracking-[1px] font-semibold gap-1 text-gray-700"
                    }
                  >
                    {value.title}
              ...
              <div
                className={
                  "w-auto flex max-[500px]:flex-col  max-[500px]:gap-4 items-center "
                }
              >
                <div
                  className={
                    "w-auto h-16 rounded-xl border-2 border-green-950 flex items-center px-4 py-0"
                  }
                >
                ...
                <div
                  className={
                    "w-auto px-4 py-2 rounded-2xl bg-white shadow flex items-center gap-3 min-[500px]:ml-8 "
                  }
                >
                  <Image
        ...
        >
          ...
          >
            ...
            <div className="w-[35%]">
              <Image className="w-full" src={myAccountImg2} alt="" />
              ...
              <div
                className={
                  "overflow-hidden cursor-pointer z-0 w-28 h-7 flex pl-7 max-[630px]:text-start items-center rounded-md text-white font-semibold bg-[#13519C] bg-gradient-to-tl from-[##13519C] to-[#13519C86] relative"
                }
              >
                <span className={"font-[400] text-[14px]"}>LOGIN</span>
                <IoIosArrowForward
                  className={"text-[50px] absolute right-0 opacity-40"}
                />
              </div>
            </div>
            <div className="w-[35%]">
              <Image className="w-full" src={myAccountImg3} alt="" />
              <div className="flex items-start justify-start flex-col">
                <p className="text-[#13519C] text-[16px] font-semibold mt-1">
                  Agent Login
                </p>
          ...
          >
            ...
            <div className="w-[85%] mt-3 flex justify-between">
              <div className="flex items-center gap-1 justify-start">
                <div className="">
                  <Image className="w-[30px]" src={helpIcon1} alt="helpIcon1" />
                </div>
              ...
              <div className="flex items-center gap-1 justify-start">
                <div className="">
                  <Image className="w-[30px]" src={helpIcon2} alt="helpIcon2" />
                </div>
                <div className="text-left">
            ...
            <div className="w-[83.5%] mt-7 flex justify-between">
              <div className="flex items-center gap-1 justify-start">
                <div className="">
                  <Image className="w-[30px]" src={helpIcon4} alt="helpIcon4" />
                </div>
                <div className="text-left">
              ...
              <div className="flex items-center gap-1 justify-start">
                <div className="">
                  <Image className="w-[30px]" src={helpIcon3} alt="helpIcon3" />
                </div>
                <div className="text-left">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-start">
          ...
          <p className="text-[#13519C] text-[22px] font-medium">
            Login with Email
          </p>
          <input
            type="text"
          ...
          />
          <button className="flex gap-8 justify-center items-center bg-[#2983D399] text-white text-[14px] font-semibold w-[175px] h-[40px] mt-5 rounded-xl">
            Send OTP <Image src={loginBtnIcon} alt="loginBtnIcon" />
          </button>
          <p className="text-[16px] text-[#00000] font-medium mt-5">
            By continuing, I agree to{" "}
            <span className="text-[#13519C]">Terms & Conditions</span>
          </p>
          <div className="w-full flex justify-end">
            <Image src={couple} alt="couple" className="w-5/12 mt-4" />
          </div>
        </div>
      </Modal>
    </>
